...
class ChatPermissions extends Entity {
  ...
  ChatPermissions(
      ...
      : super({}) {
    raw['can_send_messages'] = can_send_messages;
    raw['can_send_media_messages'] = can_send_media_messages;
    raw['can_send_polls'] = can_send_polls;
    raw['can_send_other_messages'] = can_send_other_messages;
    raw['can_add_web_page_previews'] = can_add_web_page_previews;
    raw['can_change_info'] = can_change_info;
    raw['can_invite_users'] = can_invite_users;
    raw['can_pin_messages'] = can_pin_messages;
  }
}
